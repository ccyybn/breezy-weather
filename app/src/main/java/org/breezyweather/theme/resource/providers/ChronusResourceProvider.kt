...
class ChronusResourceProvider(
    ...
    private fun getWeatherIconCode(code: WeatherCode?, daytime: Boolean): String {
        return when (code) {
            ...
            WeatherCode.RAIN, WeatherCode.SHOWERY_RAIN, WeatherCode.LIGHT_RAIN, WeatherCode.MODERATE_RAIN, WeatherCode.HEAVY_RAIN, WeatherCode.RAINSTORM -> "12"
            WeatherCode.SNOW, WeatherCode.SHOWERY_SNOW, WeatherCode.LIGHT_SNOW, WeatherCode.MODERATE_SNOW, WeatherCode.HEAVY_SNOW, WeatherCode.SNOWSTORM -> "16"
            WeatherCode.WIND -> "24"
            WeatherCode.FOG -> "20"
            WeatherCode.HAZE -> "21"
            WeatherCode.SLEET -> "5"
